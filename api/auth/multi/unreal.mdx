...
To begin, you'll need to create a config object with your `projectId`, `clientKey`, and `appId` filled in. These are retrieved from the Particle dashboard through the following steps:
...
- `In Theme`, an optional JSON string containing customization configuration. See [Particle Auth Set Auth Theme](https://docs.particle.network/developers/auth-service/sdks/web#set-auth-theme) for more information.
- `In Language`, the language used within the modal, either `en`, `zh-cn`, `zh-tw`, `ja`, or `ko`.
- `In Chain Name` & `In Chain Id`; the primary chain to be used, either EVM or Solana. For more information on specific chainId and chainName configurations, see [EVM Chains Structure](https://docs.particle.network/developers/other-services/node-service/evm-chains-api#structure).

<img
  className="block dark:hidden"
  src="/api/auth/multi/images/unreal.png"
...
<img
  className="block dark:hidden"
  src="/api/auth/multi/images/unreal2.png"
  alt="Particle Network app Unreal."
/>
<img
  className="hidden dark:block"
...
<img
  className="block dark:hidden"
  src="/api/auth/multi/images/unreal3.png"
  alt="Particle Network app Unreal."
/>
<img
  className="hidden dark:block"
...
<img
  className="block dark:hidden"
  src="/api/auth/multi/images/unreal4.png"
  alt="Particle Network app Unreal."
/>
<img
  className="hidden dark:block"
...
<img
  className="block dark:hidden"
  src="/api/auth/multi/images/unreal5.png"
  alt="Particle Network app Unreal."
/>
<img
  className="hidden dark:block"
...
<img
  className="block dark:hidden"
  src="/api/auth/multi/images/unreal6.png"
  alt="Particle Network app Unreal."
/>
<img
  className="hidden dark:block"
...
<img
  className="block dark:hidden"
  src="/api/auth/multi/images/unreal7.png"
  alt="Particle Network app Unreal."
/>
<img
  className="hidden dark:block"
