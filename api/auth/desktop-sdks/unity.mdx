...
The structure of this SDK follows the [Web (JavaScript/TypeScript)](../desktop-sdks/web) page closely, albeit with several deviations, **as described below**.
...
`ParticleSystem.Instance.SignTypedData` facilitates the signature of structured data; by default, this uses `eth_signTypedData_v4`. For more information on `signTypedData`, see the [Web (JavaScript/TypeScript)](ref:auth-web) page.
