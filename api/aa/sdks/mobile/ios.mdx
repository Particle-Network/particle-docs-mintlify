...
To get started, you'll need to have already integrated either [Particle Connect](https://particlenetwork.readme.io/reference/ios-swift) or [Particle Auth](https://particlenetwork.readme.io/reference/ios-swiftobj-c) within your iOS application. If you haven't, head over to those pages, follow the configuration process, and return here. Otherwise, you can begin by including `ParticleAA` within your Podfile, as shown below:
