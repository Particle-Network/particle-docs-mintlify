...
Before jumping in, you'll need to already have setup either [Particle Auth](https://particlenetwork.readme.io/reference/flutter-dart) or [Particle Connect](https://particlenetwork.readme.io/reference/flutter-dart-1) within your Flutter project (the AA SDK doesn't work on its own, requiring one of the two to function). If you don't have either of these already implemented, read through those pages and follow the outlined steps, then return to continue.
...
See the [Particle Auth](https://particlenetwork.readme.io/reference/flutter-dart) and [Particle Connect](https://particlenetwork.readme.io/reference/flutter-dart-1) pages for insights into additional compatible methods (such as `signAndSendTransaction`), as shown here.
