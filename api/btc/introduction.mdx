...
<img
  ...
  src="/api/btc/images/connect.png"
  alt="Particle Network BTC Connect."
/>
<img
...
3. **Account abstraction infrastructure** on said Layer-2s, such as Particle's [Omnichain Paymaster](/resources/wallet-abstraction/waas/omni-paymaster), the [Particle Bundler](/resources/wallet-abstraction/waas/bundler), etc.
...
<img
  className="block dark:hidden"
  src="/api/btc/images/architecture.jpg"
