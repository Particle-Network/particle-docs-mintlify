...
3. **Account abstraction infrastructure** on said Layer-2s, such as Particle's [Omnichain Paymaster](doc:omnichain-paymaster), the [Particle Bundler](doc:particle-bundler), etc.
...
<div class="api-container">
    <div class="api-card">
        ...
        <h3>Web SDK</h3>
        <p>Interacting with BTC Connect within React applications using either JavaScript or TypeScript.</p>
        <a href="btc-connect-web" class="api-link">Explore</a>
    </div>
</div>