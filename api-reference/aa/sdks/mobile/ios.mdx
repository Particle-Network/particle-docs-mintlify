...
AAService.initialize(name: .biconomyV1, biconomyApiKeys: [:])
...
| `chainInfo`| `ChainInfo?`| (Optional) (Optional) default is current chainInfo.|
...
// Add this Signle extension to support convert rxswift function to combine function
extension Single {
