...
<Note>
  ...
  <p>
    - Alternatively, if you'd like to instead use Biconomy's Verifying
    Paymaster, you can head over to the{" "}
    <a href="https://dashboard.biconomy.io/">Biconomy dashboard</a>, create a
    new Paymaster, and fill in `apiKey` within `initAAMode`.
  </p>
  <p>
