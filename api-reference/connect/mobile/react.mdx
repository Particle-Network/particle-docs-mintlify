...
Finally, you'll need to edit your Podfile to ensure `particle_connect` is properly imported. Head over to the [linked guide](/api-reference/connect/mobile/ios) to complete this if you have not already.
...
See the [Web (JavaScript/TypeScript)](/api-reference/auth/desktop-sdks/web) page for additional guidance.
