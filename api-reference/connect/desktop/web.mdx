...
With Particle Connect installed, you'll need to open your `index` file and wrap your `App` component with `ConnectKitProvider`, imported from `@particle-network/connectkit`. Within `ConnectKitProvider`, you'll have a variety of configurations to set:
...
Below is a code snippet showcasing a structured configuration of `ConnectKitProvider`, leveraging the parameters listed above.
