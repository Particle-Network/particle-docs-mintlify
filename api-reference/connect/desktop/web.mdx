...
const config = createConfig({
    ...
    clientKey: 'Replace with your Particle Client Key', // Retrived from https://dashboard.particle.network
...
**ConnectKit** relies on [Particle Auth](/api-reference/auth/desktop-sdks/web) for social authentication.
