...
<Frame>
<img src="https://static.particle.network/mintlify/videos/03-Embedded-wallet.gif" alt="Particle Wallet is an embeddable wallet interface that allows for unified utilization of accounts on multiple networks." style={{ width: '100%', maxWidth: '600px' }} />
</Frame>
