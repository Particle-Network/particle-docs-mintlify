...
To integrate the On-Ramp API, you can use the openBuy function from the useAuthCore() hook. 

This method allows for dynamic customization of the buy page based on user input or predefined settings.
