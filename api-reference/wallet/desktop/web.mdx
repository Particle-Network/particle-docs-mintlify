...
<Note>Follow the quickstart tutorial to set up a project and find the required keys: [Create a new project](/resources/quickstart/waas/web-quickstart#configuring-particle-auth).</Note>
