...
Additionally, specific configurations can be set within `connect()` to customize the login experience beyond [frontend customizations](/resources/quickstart/customization/auth).
...
<Tip>
  Alternatively, take a look at our [Particle Auth quickstart](/resources/quickstart/waas/web-quickstart).
</Tip>
