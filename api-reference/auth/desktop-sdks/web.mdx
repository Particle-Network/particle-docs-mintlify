...
Among all of the SDKs for Particle Auth, the Web SDK (`@particle-network/authkit`) is the most widely used and thus offers extensive support and flexibility in facilitating interaction with Particle's Wallet-as-a-Service.
...
<Tip>Learn how to customize the aesthetics of the login and embedded wallet interface in the [Customizing Login Modal](/guides/configuration/appearance/auth) and [Customizing Wallet Modal](/guides/configuration/appearance/wallet) pages.</Tip>
