...
<Tip>Check out the [Web Quickstart guide](/guides/wallet-as-a-service/waas/auth/web-quickstart) and get a new project up and running in just 5 minutes.</Tip>
...
<Tip>
    Alternatively, take a look at our [Particle Auth quickstart](/guides/wallet-as-a-service/waas/auth/web-quickstart).
</Tip>
