...
Additionally, specific configurations can be set within `connect()` to customize the login experience beyond [frontend customizations](/guides/quickstart/customization/auth).
...
<Tip>
  Alternatively, take a look at our [Particle Auth quickstart](/guides/quickstart/waas/web-quickstart).
</Tip>
...
<CardGroup cols={3}>
  <Card title="RainbowKit" href="/guides/quickstart/connection-kits/rainbow">
    Particle Auth through RainbowKit, by Rainbow.
  </Card>
  <Card title="Web3Modal" href="/guides/quickstart/connection-kits/web3modal">
    Particle Auth through Web3Modal, by WalletConnect.
  </Card>
  <Card title="Web3-Onboard" href="/guides/quickstart/connection-kits/web3-onboard">
