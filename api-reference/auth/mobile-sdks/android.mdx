...
If the user login on another device, causing the user’s token to become invalid, you can use syncUserInfo to synchronize information,it's a suspend method.
