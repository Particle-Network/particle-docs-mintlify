...
<Tip>Check the [Network Coverage](/resources/network-coverage#btc-connect) page to see which version of smart accounts is supported by each chain.</Tip>
...
- `chainId`, the ID for the currently connected chain.
  - For a complete list of networks supported within BTC Connect, see [Network Coverage](/resources/network-coverage).
