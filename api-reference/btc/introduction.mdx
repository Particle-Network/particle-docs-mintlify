...
3. **Account abstraction infrastructure** on said Layer-2s, such as Particle's [Omnichain Paymaster](/resources/integrations/aa/paymaster), the [Particle Bundler](/resources/integrations/aa/bundler), etc.
