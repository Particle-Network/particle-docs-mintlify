...
<Tip>Follow the steps outlined in the [Web Quickstart](/guides/quickstart/waas/web-quickstart#configuring-particle-auth) to create a new project and retrieve the necessary API keys.</Tip>

Click on the **JSON Web Token** button and add the necessary configuration.

![JWT configuration page](/guides/quickstart/customization/images/jwt-config.png)
