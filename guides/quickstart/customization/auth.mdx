...
The most popular method of customizing the Particle Auth interface is through programmatic style definition. Within Particle Auth Core (`@particle-network/auth-core-modal`), or their [mobile equivalents](/guides/quickstart/waas/mobile-quickstart), programmatic customization is possible during the process of initializing the SDK.
...
<img
  ...
  src="/guides/quickstart/customization/images/custom-auth.png"
