...
<img
  ...
  src="/guides/quickstart/waas/images/walletinterface.png"
...
Particle Network's Wallet-as-a-Service can be implemented either directly through the Particle Auth (Auth Core) SDK or through various connection kits, as described within [Connection Kits](/guides/quickstart/connection-kits/solana).

<div className="flex justify-center">
<img
  className="block h-64 dark:hidden"
  src="/guides/quickstart/waas/images/implementing.png"
...
<img
  className="block h-64 dark:hidden"
  src="/guides/quickstart/waas/images/providers.gif"
