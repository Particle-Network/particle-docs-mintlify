...
<Tip>Particle Network's Omnichain Paymaster can be leveraged either through Particle's AA SDK ([Web (Desktop) Quickstart](/guides/quickstart/aa/web-aa) & [Mobile (Android/iOS) Quickstart](/guides/quickstart/aa/mobile-aa)) or the [Paymaster RPC](/api-reference/aa/paymaster/paymasterbalance).</Tip>