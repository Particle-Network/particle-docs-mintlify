...
To learn more about Particle Auth Core, take a look at this [sample](https://particlenetwork.readme.io/recipes/using-particle-auth-core). To learn more about the Particle Network AA SDK, check out the [AA quickstart page](/guides/quickstart/aa/web-aa).
...
To learn more about using Particle Network's AA SDK, head over to the [AA quickstart guide](/guides/quickstart/aa/web-aa).
