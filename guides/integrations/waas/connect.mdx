...
<Frame>
<img src="https://static.particle.network/mintlify/images/02.gif" style={{ width: '100%', maxWidth: '600px' }} />
</Frame>
...
Using Particle Connect as a means of wallet connection within your application is quite straightforward and supported across several different platforms and frameworks. Whether you're building a web or mobile application or a game, Particle Connect has over seven SDKs to enable this integration. To understand the basics of working with Particle Connect programmatically, go to the [Particle Connect](/guides/wallet-as-a-service/connection-kits/particle-connect) quickstart guide. Otherwise, choose a platform to see its SDK guides from the menu below:
