...
To begin diving into the specifics of integrating Particle Auth within your platform of choice, choose the corresponding SDK reference from the cards below, or take a look at [Web (Desktop) Quickstart](/guides/quickstart/waas/web-quickstart) and [Mobile (Android/iOS) Quickstart](/guides/quickstart/waas/mobile-quickstart) for technical overviews of the integration process.

To learn more about the degree to which you can customize Particle Auth, go to [Particle Auth](/guides/quickstart/customization/auth).
