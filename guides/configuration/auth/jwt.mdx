...
Particle Network's [Dashboard](/guides/dashboard) allows developers to configure custom JWT settings to seamlessly integrate their existing user base or authentication methods, such as a custom OAuth provider.
