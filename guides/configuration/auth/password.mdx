...
1. Master Password: This is used to encrypt and back up the user's local MPC key shards. Only the user knows this password; Particle does not store it. If the user forgets it, it cannot be recovered.
