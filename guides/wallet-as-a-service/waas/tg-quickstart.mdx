...
<Note>Note that due to the nature of Telegram's in-app browser, only email login, SMS login, and embedded wallets are supported within Telegram mini-apps.</Note>
