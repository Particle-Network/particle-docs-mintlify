...
Before we begin installing and configuring the SDK, you'll need a project that meets the prerequisites listed below (otherwise you may face compatibility issues).
