...
Finally, before initializing and utilizing Particle Auth directly, you'll additionally need to place your project keys within your `AndroidManifest.xml` (both this and `build.gradle` need to contain these keys).

An example of this file has been included below, and the areas in which project keys are needed have been marked.
    ...
    <application
        ...
        <activity
            ...
            <intent-filter>
                ...
                <data android:scheme="ac${PN_APP_ID}" /> <!-- Replace this with your App ID -->
            </intent-filter>
        </activity>
        ...
        <activity
            ...
            <intent-filter>
                ...
                <data android:scheme="connect${PN_APP_ID}" /> <!-- Replace this with your App ID -->
            </intent-filter>
        </activity>

        <meta-data
            android:name="particle.network.project_client_key"
            android:value="${PN_PROJECT_CLIENT_KEY}" /> <!-- Replace this with your Client Key -->

        <meta-data
            android:name="particle.network.app_id"
            android:value="${PN_APP_ID}" /> <!-- Replace this with your App ID -->

        <meta-data
            android:name="particle.network.project_id"
            android:value="${PN_PROJECT_ID}" /> <!-- replace this with your Project ID -->
