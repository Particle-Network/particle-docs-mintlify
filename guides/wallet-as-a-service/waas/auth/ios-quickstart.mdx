...
<Note>
  For complete documentation covering the implementation of Particle Auth on Android in more depth, head over to the [iOS SDK reference](/api-reference/auth/mobile-sdks/ios).
</Note>
...
Particle Auth supports Wallet SDK, follow the wallet [documentation](/api-reference/wallet/mobile/ios.mdx), add required pods to your Podfile.
