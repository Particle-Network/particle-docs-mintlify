...
- `network.particle:connect-evm-adapter`, if using EVM private key login.(not recommended)
- `network.particle:connect-solana-adapter`, if using Solana private key login.(not recommended)
