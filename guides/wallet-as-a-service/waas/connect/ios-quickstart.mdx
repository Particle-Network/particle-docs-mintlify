...
<Accordion title="You can retrieve the project ID from the [WalletConnect dashboard](https://cloud.walletconnect.com); it is used when connecting with traditional Web3 wallets.">
<div className="flex justify-center">
<img
  className="block h-64 dark:hidden"
