...
After running one of the aforementioned commands, the CLI will prompt you to enter a project name and select the framework (Next.js or React) you wish to use. 
...
- `projectId`, `clientKey`, and `appId` — Get these from the [Particle dashboard](https://www.particle.network/dashboard), as covered prior.
