...
Within this page, you'll find a quick rundown on installing, configuring, and using Particle's AA SDK (tying in directly with its Bundler and Paymaster).
...
For a complete reference of each method available on `smartAccount`, see the table below, or for more usage information, take a look at the AA Web SDK rundown at [AA Web SDK](/aa/sdks/desktop/web).
