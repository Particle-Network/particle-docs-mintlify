...
<CardGroup cols="1">
  ...
  <Card title="Social Login Quickstart" icon="wand-magic-sparkles" href="/social-login/quickstart">
    Add Social Logins to your dApp with just a few lines of code.
  </Card>
  <Card title="Account Abstraction Quickstart" icon="bolt" href="/account-abstraction/quickstart">
