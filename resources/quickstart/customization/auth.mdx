...
The most popular method of customizing the Particle Auth interface is through programmatic style definition. Within Particle Auth Core (`@particle-network/auth-core-modal`), or their [mobile equivalents](https://particlenetwork.readme.io/docs/mobile-androidios-quickstart), programmatic customization is possible during the process of initializing the SDK.
