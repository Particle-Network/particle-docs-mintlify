...
To learn more about these methods and see an interactive API example, head over to [Paymaster RPC](ref:paymaster-rpc). 
...
To dive further into setting up a sponsorship Webhook and requesting gas sponsorship on a user operation, take a look at [Setting up a Paymaster](doc:setting-up-a-paymaster), or to learn more about our Omnichain Paymaster's architecture, head over to [Omnichain Paymaster](doc:omnichain-paymaster).