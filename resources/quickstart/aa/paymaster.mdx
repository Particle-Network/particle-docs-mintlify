...
To learn more about these methods and see an interactive API example, head over to [Paymaster RPC](/api/aa/paymaster/paymasterbalance). 
...
<img
  ...
  src="/resources/quickstart/aa/images/paymaster.png"
  alt="Pymaster menu."
/>
<img
...
To dive further into setting up a sponsorship Webhook and requesting gas sponsorship on a user operation, take a look at [Setting up a Paymaster](/resources/integrations/aa/paymaster), or to learn more about our Omnichain Paymaster's architecture, head over to [Omnichain Paymaster](/resources/wallet-abstraction/waas/omni-paymaster).