...
For a complete reference of each method available on `smartAccount`, see the table below, or for more usage information, take a look at the AA Web SDK rundown at [AA Web SDK](ref:aa-web).
