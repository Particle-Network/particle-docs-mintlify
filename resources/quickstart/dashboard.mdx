...
<img
  ...
  src="/resources/quickstart/images/project.png"
...
<img
  className="block h-64 dark:hidden"
  src="/resources/quickstart/images/application.png"
...
<img
  className="block h-64 dark:hidden"
  src="/resources/quickstart/images/user-activity.png"
...
<img
  className="block h-64 dark:hidden"
  src="/resources/quickstart/images/verification-sms.png"
...
<img
  className="block h-64 dark:hidden"
  src="/resources/quickstart/images/team.png"
...
Particle Network's older SDKs, such as `@particle-network/auth` (not Particle Auth Core) can be customized through the "Branding" tab. This customization includes significant changes to coloring, borders, and text within the login, verification, and transaction interfaces. For newer SDKs, such as Particle Auth Core, these interfaces need to be programmatically customized.

<div className="flex justify-center">
<img
  className="block h-64 dark:hidden"
  src="/resources/quickstart/images/branding.png"
  alt="Particle Network branding."
/>
<img
  className="hidden h-64 dark:block"
  src="/resources/quickstart/images/branding.png"
...
Although applicable across all versions of Particle Auth is the Email/SMS customization present on this page; this tab allows you to change the logo and brand name present within the login verification SMS and email messages.

<div className="flex justify-center">
<img
  className="block h-64 dark:hidden"
  src="/resources/quickstart/images/branding-2.png"
  alt="Particle Network branding."
/>
<img
  className="hidden h-64 dark:block"
...
For more information on modal customization, head over to [Customizing Particle Auth](/resources/quickstart/customization/auth) and [Customizing Particle Wallet](/resources/quickstart/customization/wallet).
...
<img
  className="block h-64 dark:hidden"
  src="/resources/quickstart/images/users.png"
...
<img
  className="block h-64 dark:hidden"
  src="/resources/quickstart/images/custom.png"
...
The Particle dashboard is also used to fund and monitor Particle's [Omnichain Paymaster](/resources/wallet-abstraction/waas/omni-paymaster), used for sponsoring transactions across 35+ chains. Particle's Omnichain Paymaster takes stablecoin deposits from one chain (such as Ethereum or BNB Chain) and automatically converts it to cover transaction fees on any other chain on which the paymaster is queried ([sponsorUserOperation](/api/aa/paymaster/sponsoruseroperation)).
...
To learn more about the process of configuring Particle's Omnichain Paymaster, take a look at [Setting up the Particle Omnichain Paymaster](/resources/integrations/aa/paymaster).

<div className="flex justify-center">
<img
  className="block h-64 dark:hidden"
  src="/resources/quickstart/images/paymaster.png"
...
To learn more about Particle Network's RPC nodes, head to [RPC Nodes](/resources/integrations/nodes/nodes).

<div className="flex justify-center">
<img
  className="block h-64 dark:hidden"
  src="/resources/quickstart/images/endpoint.png"
...
<img
  className="block h-64 dark:hidden"
  src="/resources/quickstart/images/stats.png"
...
width="600"
height="400" 
src="https://www.youtube.com/embed/d7DYCMNDmjo" 
title="Particle Dashboard Setup in Just 3 Minutes" 
alt="Particle Dashboard Setup in Just 3 Minutes"
frameborder="0"
