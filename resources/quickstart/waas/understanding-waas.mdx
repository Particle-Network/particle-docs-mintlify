...
Particle Network's Wallet-as-a-Service can be implemented either directly through the Particle Auth (Auth Core) SDK or through various connection kits, as described within [Connection Kits](doc:connection-kits).
...
For more information on comparing various Wallet-as-a-Service providers, look at [Particle vs. Alternatives](doc:particle-vs-alternatives).
