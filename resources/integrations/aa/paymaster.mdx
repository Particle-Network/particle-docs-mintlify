...
Once you've deposited USDT, you're can define sponsorship conditions and sponsoring transactions on any supported EVM chain (see [Network Coverage](/resources/network-coverage)).
...
<Tip>Particle Network's Omnichain Paymaster can be leveraged either through Particle's AA SDK ([Web (Desktop) Quickstart](/resources/quickstart/aa/web-aa) & [Mobile (Android/iOS) Quickstart](/resources/quickstart/aa/mobile-aa)) or the [Paymaster RPC](/api-reference/aa/paymaster/paymasterbalance).</Tip>