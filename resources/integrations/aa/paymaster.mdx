...
<img
  className="block dark:hidden"
  src="/resources/integrations/aa/images/validate.png"
...
<Tip>Particle Network's Omnichain Paymaster can be leveraged either through Particle's AA SDK ([Web (Desktop) Quickstart](/resources/quickstart/aa/web-aa) & [Mobile (Android/iOS) Quickstart](/resources/quickstart/aa/mobile-aa)) or the [Paymaster RPC](/api/aa/paymaster/paymasterbalance).</Tip>