...
To learn more about Particle Auth Core, take a look at this [sample](https://particlenetwork.readme.io/recipes/using-particle-auth-core). To learn more about the Particle Network AA SDK, check out the [AA quickstart page](/resources/quickstart/aa/web-aa).
...
While often used directly with Smart Wallet-as-a-Service, Particle Network's account abstraction infrastructure can also be leveraged independently within any project, even if it isn't using Smart Wallet-as-a-Service. This is especially true of the [Particle Bundler](/resources/wallet-abstraction/waas/bundler), [AA SDK/RPC](/api/aa/sdks/desktop/web), and [Omnichain Paymaster](/resources/wallet-abstraction/waas/omni-paymaster), all of which can be used to construct, sponsor, and send UserOperations for free.
...
Learn more about [working with Particle Network's Paymaster](/resources/integrations/aa/paymaster).
...
To learn more about using Particle Network's AA SDK, head over to the [AA quickstart guide](/resources/quickstart/aa/web-aa).
