...
<img
  ...
  src="/resources/integrations/partners/images/zetachain.gif"
...
To learn more about Particle Auth Core, take a look at this [sample](https://particlenetwork.readme.io/recipes/using-particle-auth-core). To learn more about the Particle Network AA SDK, check out the [AA quickstart page](doc:aa-web-quickstart).
...
While often used directly with Smart Wallet-as-a-Service, Particle Network's account abstraction infrastructure can also be leveraged independently within any project, even if it isn't using Smart Wallet-as-a-Service. This is especially true of the [Particle Bundler](doc:particle-bundler), [AA SDK/RPC](ref:aa-web), and [Omnichain Paymaster](doc:omnichain-paymaster), all of which can be used to construct, sponsor, and send UserOperations for free.
...
Learn more about [working with Particle Network's Paymaster](https://particlenetwork.readme.io/docs/setting-up-particles-paymaster).
...
To learn more about using Particle Network's AA SDK, head over to the [AA quickstart guide](https://particlenetwork.readme.io/docs/aa-web-quickstart).
