...
Particle Network provides free-to-use RPC nodes as a complementary technology to the other components of its tech stack. This RPC is used within the backend of various Particle Network modals and demos, and thus is open to use through any supported network ([Network Coverage](/resources/quickstart/network-coverage)) and can be used for any standard RPC method available on these chains.
...
<img
  ...
  src="/resources/integrations/nodes/images/nodes-features.png"
...
To begin building with Particle Network's RPC nodes, head over to the [Particle dashboard](https://dashboard.particle.network/#/login). From here, spin up a project and navigate to the **Endpoint** page within the **NODE RPC** section. You'll then be able to choose a specific chain and retrieve an endpoint. 
...
<img
  className="block dark:hidden"
  src="/resources/integrations/nodes/images/endpoint.png"
