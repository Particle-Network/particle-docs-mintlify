...
Particle Network provides free-to-use RPC nodes as a complementary technology to the other components of its tech stack. This RPC is used within the backend of various Particle Network modals and demos, and thus is open to use through any supported network ([Network Coverage](doc:network-coverage)) and can be used for any standard RPC method available on these chains.
