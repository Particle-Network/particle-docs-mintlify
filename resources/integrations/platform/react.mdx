...
<CardGroup cols={3}>
  <Card title="Particle Auth" href="/api/auth/mobile-sdks/react">
    Interacting with Particle Auth within applications made using React Native.
  </Card>
  <Card title="Particle Connect" href="/api/connect/mobile/react">
    Integrating Particle Connect within applications made using React Native.
  </Card>
   <Card title="Particle Wallet" href="/api/wallet/mobile/react">
