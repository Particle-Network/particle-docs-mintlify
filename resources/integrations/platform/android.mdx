...
<CardGroup cols={2}>
  <Card title="Particle Auth" href="/api/auth/mobile-sdks/android">
    Interacting with Particle Auth on Android using Kotlin.
  </Card>
  <Card title="Particle Connect" href="/api/connect/mobile/android">
    Integrating Particle Connect on Android using Kotlin.
  </Card>
   <Card title="Particle Wallet" href="/api/wallet/mobile/android">
    Using Particle Wallet within Android applications.
  </Card>
     <Card title="Account Abstraction" href="/api/aa/sdks/mobile/android">
