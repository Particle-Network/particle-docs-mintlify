...
To begin diving into the specifics of integrating Particle Auth within your platform of choice, choose the corresponding SDK reference from the cards below, or take a look at [Web (Desktop) Quickstart](/resources/quickstart/waas/web-quickstart) and [Mobile (Android/iOS) Quickstart](/resources/quickstart/waas/mobile-quickstart) for technical overviews of the integration process. 

To learn more about the degree to which you can customize Particle Auth, go to [Particle Auth](/resources/quickstart/customization/auth).
