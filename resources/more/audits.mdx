...
> 🏅 Particle Network has private audits with [Salus Sec](https://salusec.io/), as well as public ones with [CertiK](https://www.certik.com/). To see our CertiK audit page, [click here](https://skynet.certik.com/projects/particle-network).
> 
