...
<Frame caption="Particle's MPC-TSS approach.">
<img
  className="block dark:hidden"
  src="/resources/wallet-abstraction/waas/images/mpc-tss.png"
  alt="Particle's MPC-TSS approach."
/>
<img
...
<Tip>For a comparison between Particle Network's solution and others present in the market, like Shamir's Secret Sharing, visit "[Key Differentiators](https://particlenetwork.readme.io/docs/particle-vs-alternatives)".</Tip>