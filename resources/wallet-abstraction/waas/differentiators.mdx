...
<Note>Note: This chapter refers only to Particle's live [Modular Smart WaaS](https://particlenetwork.readme.io/docs/technological-components) stack. As we release additional components, it'll be expanded to cover their unique aspects too. As a first-of-its-kind product, [BTC Connect](doc:btc-connect) is not covered here either.</Note>
...
<img
  ...
  src="/resources/wallet-abstraction/waas/images/comparison.png"
...
<Tip>For a deeper dive into Particle's MPC-TSS solution, [click here](https://particlenetwork.readme.io/docs/security-mpc-tss).</Tip>
...
<img
  className="block dark:hidden"
  src="/resources/wallet-abstraction/waas/images/mpc-tss.png"
...
- **Paymasters:** One of the prominent use cases of AA is the ability for dApps to sponsor gas fees for users, which Paymasters enable. This makes particular sense in solutions hosted in L2s, which typically have low costs for users. Paymasters can allow your dApp to accept gas fee payments in any native (not bridged) token, preventing users from constantly needing to acquire gas tokens. Particle has built a dedicated [Omnichain Paymaster](https://particlenetwork.readme.io/docs/omnichain-paymaster) as a part of its AA stack. 
- **Bundlers:** Bundlers aggregate user actions for efficient blockchain interactions, potentially leading to reduced transaction fees and faster transaction confirmations​. Bundlers can result in better cost-efficiency for end-users and better performance for developers. Particle has also developed [an open-source Bundler](https://particlenetwork.readme.io/docs/particle-bundler), natively integrated into our AA stack.
...
<img
  className="block dark:hidden"
  src="/resources/wallet-abstraction/waas/images/implementations.png"
...
<img
  className="block dark:hidden"
  src="/resources/wallet-abstraction/waas/images/modular-waas.png"
