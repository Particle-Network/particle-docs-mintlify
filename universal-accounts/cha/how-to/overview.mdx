...
- **[Integrate with Browser Wallets](/universal-accounts/cha/how-to/provider)** — connect standard EOA wallets and enable hybrid login with Universal Accounts.  
- **[Build a Balance Widget](/universal-accounts/cha/how-to/balances)** — fetch, aggregate, and display user balances across all supported chains in one view.  
- **[Use Universal Accounts as Deposit Flow](/universal-accounts/cha/how-to/deposit-flow)** — accept deposits in stablecoins or tokens from any supported chain, automatically available on your target network without bridges.  
- **[Preview Transaction Details](/universal-accounts/cha/how-to/tx-preview)** — generate transaction previews using the SDK to verify execution parameters and simulate cross-chain actions.  
- **[Convert Primary Assets](/universal-accounts/cha/how-to/conversions)** — convert or swap tokens within a Universal Account, supporting **multi-chain liquidity** and **gas abstraction**.
- **[Integrate with Magic Wallet API](/universal-accounts/cha/how-to/magic-ua)** — integrate Universal Accounts with Magic Wallet API.
...
<CardGroup cols={3}>
  ...
  <Card title="Use Universal Accounts as Deposit Flow" href="/universal-accounts/cha/how-to/deposit-flow" icon="coin">
  ...
  <Card title="Integrate with Magic Wallet API" href="/universal-accounts/cha/how-to/magic-ua" icon="wand-magic-sparkles">
    Integrate Universal Accounts with Magic Wallet API.
  </Card>
</CardGroup>
