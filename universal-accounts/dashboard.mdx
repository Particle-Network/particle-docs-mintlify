...
1. **Application**, a specific instance of Particle Auth or BTC Connect on either iOS, Android, or Web.
   An application, denominated by the **App ID**, acts as the identifier for a given instance of Particle Network. During construction, applications have a few options to consider:
