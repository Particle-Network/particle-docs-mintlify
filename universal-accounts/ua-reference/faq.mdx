...
- **Liquidity provider (LP) fee**: A 0.2% fee applied only to cross-chain transactions, paid to the LP handling the transfer.
- **Transaction fee**: A 1% fee calculated on transaction volume.
...
Fees can be edited on a _per-project_ basis. Reach out to [Particle Support](https://t.me/particle_developer_bot) for assistance.
