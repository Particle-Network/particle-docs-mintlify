...
<div className="chain-abstraction">
  <a href="/landing/modular-l1/introduction">Modular L1</a> • 
  <a href="/landing/modular-l1/universal-accounts">Universal Accounts</a> • 
  <a href="/landing/modular-l1/universal-liquidity">Universal Liquidity</a> • 
  <a href="/landing/modular-l1/universal-gas">Universal Gas</a>
</div>
...
<CardGroup cols={3}>
  ...
  <Card title="Web3 Services" icon="webhook" href="../api-reference/web3">
    Access to node rpcs, enhanced data apis, fiat on-ramps and much more.
  </Card>
</CardGroup>
