...
<CardGroup cols={3}>
  <Card title="Account Abstraction" icon="credit-card">
  ...
  <Card title="Particle Auth" icon="shield">
  ...
  <Card title="Web3 Services" icon="webhook">
    Connect to both Web 2.0 accounts and mainstream wallets, enhancing accessibility through a unified interface.
  </Card>
</CardGroup>
...
**[Modular L1](#)** • [Universal Accounts](#) • [Universal Liquidity](#) • [Universal Gas](#)
