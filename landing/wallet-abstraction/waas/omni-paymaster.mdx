...
<Frame caption="Whitelist Smart Contracts for Paymaster on Dashboard">
![Whitelist Smart Contracts for Paymaster on Dashboard](/landing/wallet-abstraction/waas/images/paymaster-whitelist.png)
</Frame>
