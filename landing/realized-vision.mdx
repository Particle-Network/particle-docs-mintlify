...
900+ integrations and more than 17 Million activated wallets later, remaining focused on propelling Web3’s growth, we decided to take our solutions to the next level, addressing Web3's largest UX problem: the fragmentation of users and liquidity. This solution receives the name **chain abstraction**.
...
Particle Network aims to solve Web3’s fragmentation of users and wallets across chains, providing three key services for chain abstraction:
