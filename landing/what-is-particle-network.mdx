...
Particle Network is primarily constituted by three key modules. For a detailed description of these modules you can read our [Modular L1](/landing/modular-l1/introduction) section.
