---
title: "Simple Deposit — React API"
sidebarTitle: "React SDK"
description: "React API reference for the Simple Deposit: DepositProvider, hooks, and UI components."
---
...
```tsx
import { useDeposit } from '@particle-network/simple-deposit/react';
...
```tsx
import { useDepositContext } from '@particle-network/simple-deposit/react';
...
```tsx
import { DepositWidget } from '@particle-network/simple-deposit/react';
...
```tsx
import { DepositModal } from '@particle-network/simple-deposit/react';
...
```tsx
import { RecoveryWidget } from '@particle-network/simple-deposit/react';
...
```tsx
import { RecoveryModal } from '@particle-network/simple-deposit/react';
